...
<template>
	<li v-click-outside="disableEdit"
		...
		:aria-label="t('build', 'Question number {index}', {index})"
		class="question"
		@click="enableEdit">
		<!-- Drag handle -->
		...
		<div v-if="!readOnly"
			...
			:aria-label="t('build', 'Drag to reorder the questions')" />

		<!-- Header -->
		<div class="question__header">
			<input v-if="edit || !text"
				:placeholder="titlePlaceholder"
				:aria-label="t('build', 'Title of question number {index}', {index})"
				:value="text"
...
export default {
	...
	props: {
		...
		warningInvalid: {
			type: String,
			default: t('build', 'This question needs a title!'),
		},
	},
