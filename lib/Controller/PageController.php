...
use OCA\Build\Db\Form;
use OCA\Build\Db\FormMapper;
use OCA\Build\Service\FormsService;
...
class PageController extends Controller {
	...
	public function index(): TemplateResponse {
		...
		Util::addStyle($this->appName, 'build');
	...
	public function provideTemplate(string $template, Form $form = null): ?TemplateResponse {
		...
		if (!$this->userSession->isLoggedIn()) {
			...
			// Set Header
			$response->setHeaderTitle($this->l10n->t('build'));
